<template lang="html">
  <div class='container'>
    ...
    <button type="button" @click="increment" class="shake-lr">
      ...
      <img v-if="showState >= 80 && showState <100" src="../assets/grandpa.png">
      <img v-if="showState >= 100 && showState <110" src="../assets/papa.png">
    </button>
